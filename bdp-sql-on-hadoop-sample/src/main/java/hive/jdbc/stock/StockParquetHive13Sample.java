...
public class StockParquetHive13Sample {
    JdbcTemplate jdbcTemplate;

    public StockParquetHive13Sample(JdbcTemplate jdbcTemplate) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        prop.load(StockParquetHive13Sample.class.getResourceAsStream("/jdbc.properties"));
        ...
        new StockParquetHive13Sample(new JdbcTemplate(dataSource)).run();
    }
}